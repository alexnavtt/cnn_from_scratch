...
int main(int argc, char* argv[]){
    ...
    M.subMat({1, 2, 0}, {4, 1, 2}) = 1;
    std::cout << M;
    std::cout << "\n";

    try{
        M.subMat({1, 2, 0}, {1, 4, 2}) = 1;
    ...
    // my_cnn::SimpleMatrix<float> OSM = M.subMatrix({0, 0, 0}, {3, 3, 1});
    ...
    // my_cnn::SimpleMatrix<float> SSM = M.subMatrix({0, 0, 0}, {2, 3, 2});
